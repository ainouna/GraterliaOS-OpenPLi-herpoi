...
def InitUsageConfig():
	...
	config.usage.e2_debug_level = ConfigSelectionNumber(0, 6, 1, default = 0)
	...
	config.usage.hdd_standby = ConfigSelection(default = "-1", choices = [("-1", _("Controlled outside")), ("0", _("No standby"))] + choicelist)
